...
avg_loan_amount=y/x
print("The avergae loan amount is $",avg_loan_amount)
...
print ("The remain months on the loan is:",remaining_months)
...
for item in loans: 
    ...
    if loan_price <=500:
        inexspensive_loans.append(loan_price)
# print("The inexspensive loans are:")
